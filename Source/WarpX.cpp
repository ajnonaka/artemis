...
WarpX::ReadParameters ()
{
...

    {
        ...
        // turn on the exchange coupling term H_exchange for H_eff in the LLG equation
                      ...
                      const IntVect& ngF, const IntVect& ngG, const bool aux_is_nodal)
{
    ...
    AllocInitMultiFab(Mfield_fp[lev][1], amrex::convert(ba,My_nodal_flag), dm, 3, ngEB, tag("Mfield_fp[y]"));
    AllocInitMultiFab(Mfield_fp[lev][2], amrex::convert(ba,Mz_nodal_flag), dm, 3, ngEB, tag("Mfield_fp[z]"));

    AllocInitMultiFab(Hfield_fp[lev][0], amrex::convert(ba,Hx_nodal_flag), dm, ncomps, ngEB, tag("Hfield_fp[x]"));
    AllocInitMultiFab(Hfield_fp[lev][1], amrex::convert(ba,Hy_nodal_flag), dm, ncomps, ngEB, tag("Hfield_fp[y]"));
    AllocInitMultiFab(Hfield_fp[lev][2], amrex::convert(ba,Hz_nodal_flag), dm, ncomps, ngEB, tag("Hfield_fp[z]"));

    AllocInitMultiFab(H_biasfield_fp[lev][0], amrex::convert(ba,Hx_bias_nodal_flag), dm, ncomps, ngEB, tag("Hbiasfield_fp[x]"));
    AllocInitMultiFab(H_biasfield_fp[lev][1], amrex::convert(ba,Hy_bias_nodal_flag), dm, ncomps, ngEB, tag("Hbiasfield_fp[y]"));
    AllocInitMultiFab(H_biasfield_fp[lev][2], amrex::convert(ba,Hz_bias_nodal_flag), dm, ncomps, ngEB, tag("Hbiasfield_fp[z]"));
#endif
...
#ifdef WARPX_MAG_LLG
        AllocInitMultiFab(Mfield_aux[lev][0], nba, dm,3     ,ngEB, tag("Mfield_aux[x]"), 0.0_rt);
        AllocInitMultiFab(Mfield_aux[lev][1], nba, dm,3     ,ngEB, tag("Mfield_aux[y]"), 0.0_rt);
        AllocInitMultiFab(Mfield_aux[lev][2], nba, dm,3     ,ngEB, tag("Mfield_aux[z]"), 0.0_rt);

        AllocInitMultiFab(Hfield_aux[lev][0], nba, dm,3     ,ngEB, tag("Hfield_aux[x]"), 0.0_rt);
        AllocInitMultiFab(Hfield_aux[lev][1], nba, dm,3     ,ngEB, tag("Hfield_aux[y]"), 0.0_rt);
        AllocInitMultiFab(Hfield_aux[lev][2], nba, dm,3     ,ngEB, tag("Hfield_aux[z]"), 0.0_rt);

        AllocInitMultiFab(H_biasfield_aux[lev][0], nba, dm,3     ,ngEB, tag("H_biasfield_aux[x]"), 0.0_rt);
        AllocInitMultiFab(H_biasfield_aux[lev][1], nba, dm,3     ,ngEB, tag("H_biasfield_aux[y]"), 0.0_rt);
        AllocInitMultiFab(H_biasfield_aux[lev][2], nba, dm,3     ,ngEB, tag("H_biasfield_aux[z]"), 0.0_rt);
#endif
...
#ifdef WARPX_MAG_LLG
            AliasInitMultiFab(H_biasfield_aux[lev][0], *H_biasfield_fp[lev][0], 0, ncomps, tag("Hbias_aux[x]"), 0.0_rt);
            AliasInitMultiFab(H_biasfield_aux[lev][1], *H_biasfield_fp[lev][1], 0, ncomps, tag("Hbias_aux[y]"), 0.0_rt);
            AliasInitMultiFab(H_biasfield_aux[lev][2], *H_biasfield_fp[lev][2], 0, ncomps, tag("Hbias_aux[z]"), 0.0_rt);

            AliasInitMultiFab(Hfield_aux[lev][0], *Hfield_fp[lev][0], 0, ncomps, tag("Hfield_aux[x]"), 0.0_rt);
            AliasInitMultiFab(Hfield_aux[lev][1], *Hfield_fp[lev][1], 0, ncomps, tag("Hfield_aux[y]"), 0.0_rt);
            AliasInitMultiFab(Hfield_aux[lev][2], *Hfield_fp[lev][2], 0, ncomps, tag("Hfield_aux[z]"), 0.0_rt);

            AliasInitMultiFab(Mfield_aux[lev][0], *Mfield_fp[lev][0], 0, 3, tag("Mfield_aux[x]"), 0.0_rt);
            AliasInitMultiFab(Mfield_aux[lev][1], *Mfield_fp[lev][1], 0, 3, tag("Mfield_aux[y]"), 0.0_rt);
            AliasInitMultiFab(Mfield_aux[lev][2], *Mfield_fp[lev][2], 0, 3, tag("Mfield_aux[z]"), 0.0_rt);
#endif
        } else {
...
#ifdef WARPX_MAG_LLG
        AllocInitMultiFab(Mfield_aux[lev][0], amrex::convert(ba,Mx_nodal_flag),dm,3     ,ngEB, tag("Mfield_aux[x]"));
        AllocInitMultiFab(Mfield_aux[lev][1], amrex::convert(ba,My_nodal_flag),dm,3     ,ngEB, tag("Mfield_aux[y]"));
        AllocInitMultiFab(Mfield_aux[lev][2], amrex::convert(ba,Mz_nodal_flag),dm,3     ,ngEB, tag("Mfield_aux[z]"));
        AllocInitMultiFab(Hfield_aux[lev][0], amrex::convert(ba,Hx_nodal_flag),dm,ncomps,ngEB, tag("Hfield_aux[x]"));
        AllocInitMultiFab(Hfield_aux[lev][1], amrex::convert(ba,Hy_nodal_flag),dm,ncomps,ngEB, tag("Hfield_aux[y]"));
        AllocInitMultiFab(Hfield_aux[lev][2], amrex::convert(ba,Hz_nodal_flag),dm,ncomps,ngEB, tag("Hfield_aux[z]"));
        AllocInitMultiFab(H_biasfield_aux[lev][0], amrex::convert(ba,Hx_bias_nodal_flag), dm, ncomps, ngEB, tag("Hbiasfield_aux[x]"));
        AllocInitMultiFab(H_biasfield_aux[lev][1], amrex::convert(ba,Hy_bias_nodal_flag), dm, ncomps, ngEB, tag("Hbiasfield_aux[y]"));
        AllocInitMultiFab(H_biasfield_aux[lev][2], amrex::convert(ba,Hz_bias_nodal_flag), dm, ncomps, ngEB, tag("Hbiasfield_aux[z]"));
#endif
    }
...
#ifdef WARPX_MAG_LLG
                AllocInitMultiFab(Mfield_cax[lev][0], cnba,dm,3     ,ngEB, tag("Mfield_cax[x]"));
                AllocInitMultiFab(Mfield_cax[lev][1], cnba,dm,3     ,ngEB, tag("Mfield_cax[y]"));
                AllocInitMultiFab(Mfield_cax[lev][2], cnba,dm,3     ,ngEB, tag("Mfield_cax[z]"));
                AllocInitMultiFab(Hfield_cax[lev][0], cnba,dm,ncomps,ngEB, tag("Hfield_cax[x]"));
                AllocInitMultiFab(Hfield_cax[lev][1], cnba,dm,ncomps,ngEB, tag("Hfield_cax[y]"));
                AllocInitMultiFab(Hfield_cax[lev][2], cnba,dm,ncomps,ngEB, tag("Hfield_cax[z]"));
                AllocInitMultiFab(H_biasfield_cax[lev][0], cnba,dm,ncomps,ngEB, tag("Hbiasfield_cax[x]"));
                AllocInitMultiFab(H_biasfield_cax[lev][1], cnba,dm,ncomps,ngEB, tag("Hbiasfield_cax[y]"));
                AllocInitMultiFab(H_biasfield_cax[lev][2], cnba,dm,ncomps,ngEB, tag("Hbiasfield_cax[z]"));
#endif
            } else {
                // Create the MultiFabs for B
...
#ifdef WARPX_MAG_LLG
                // Create the MultiFabs for M
                Mfield_cax[lev][0] = std::make_unique<MultiFab>(amrex::convert(cba,Mx_nodal_flag),dm,3     ,ngEB);
                Mfield_cax[lev][1] = std::make_unique<MultiFab>(amrex::convert(cba,My_nodal_flag),dm,3     ,ngEB);
                Mfield_cax[lev][2] = std::make_unique<MultiFab>(amrex::convert(cba,Mz_nodal_flag),dm,3     ,ngEB);

                // Create the MultiFabs for H
                Hfield_cax[lev][0] = std::make_unique<MultiFab>(amrex::convert(cba,Hx_nodal_flag),dm,ncomps,ngEB);
                Hfield_cax[lev][1] = std::make_unique<MultiFab>(amrex::convert(cba,Hy_nodal_flag),dm,ncomps,ngEB);
                Hfield_cax[lev][2] = std::make_unique<MultiFab>(amrex::convert(cba,Hz_nodal_flag),dm,ncomps,ngEB);

                // Create the MultiFabs for H_bias
                H_biasfield_cax[lev][0] = std::make_unique<MultiFab>(amrex::convert(cba,Hx_bias_nodal_flag),dm,ncomps,ngEB);
                H_biasfield_cax[lev][1] = std::make_unique<MultiFab>(amrex::convert(cba,Hy_bias_nodal_flag),dm,ncomps,ngEB);
                H_biasfield_cax[lev][2] = std::make_unique<MultiFab>(amrex::convert(cba,Hz_bias_nodal_flag),dm,ncomps,ngEB);
#endif
                // Create the MultiFabs for E
